...
static GPIO_info_t SPI_csTable[] = {
    [SPI_CS_1] = {GPIOA, { GPIO_PIN_4, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH}},
    [SPI_CS_2] = {GPIOA, { GPIO_PIN_8, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH}},
    [SPI_CS_3] = {GPIOA, { GPIO_PIN_9, GPIO_MODE_OUTPUT_PP, GPIO_PULLUP, GPIO_SPEED_FREQ_HIGH}}
};
